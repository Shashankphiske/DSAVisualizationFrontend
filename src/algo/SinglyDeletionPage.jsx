...
const SinglyDeletionPage = () => {
  ...
  const handlePlay = async () => {
    ...
    if (steps.length === 0) {
      ...
      setExplanation("Starting Singly Linked List Deletion...");
  ...
  const generateExplanation = (step) => {
    if (step.current) {
      return `Deleting node at index ${deleteIndex}. Traversing to position...`;
    }
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white p-8 pt-25">
      <h1 className="text-3xl font-bold text-center mb-6">
        Singly Linked List - Deletion Visualization
      </h1>

      <div className="max-w-4xl mx-auto bg-gray-800 p-6 rounded mb-6">
        <h2 className="text-xl font-semibold mb-2">About Singly Linked List Deletion</h2>
        <p className="text-gray-300 text-sm">
          Deletion in a singly linked list involves adjusting pointers to remove a node at the specified position.
        </p>
